...
function StudyAssistant(){
 const[open,setOpen]=useState(false),[input,setInput]=useState(''),[model,setModel]=useState(()=>localStorage.getItem('beisen-assistant-model-v1')||'deepseek-chat'),[messages,setMessages]=useState([{role:'assistant',text:'我是本机学习助手。可以先问“为什么选这个”或“这题有什么技巧”。'}]);
